...
class ModifySearchHolidayVC: BaseTableVC {
    ...
    static var newInstance: ModifySearchHolidayVC? {
        let storyboard = UIStoryboard(name: Storyboard.Holidays.name,
                                      bundle: nil)
        let vc = storyboard.instantiateViewController(withIdentifier: self.className()) as? ModifySearchHolidayVC
        return vc
    }
...
extension ModifySearchHolidayVC {
