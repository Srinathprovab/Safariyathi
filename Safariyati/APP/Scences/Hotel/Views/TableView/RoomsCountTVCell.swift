...
class RoomsCountTVCell: UITableViewCell {
    ...
    func setupUI() {
        ...
        decrimentImage4.image = UIImage(named: "sub")?.withRenderingMode(.alwaysOriginal)
        decrimentImage2.image = UIImage(named: "sub")?.withRenderingMode(.alwaysOriginal)
        decrimentImage3.image = UIImage(named: "sub")?.withRenderingMode(.alwaysOriginal)
        decrimentImage.image = UIImage(named: "sub")?.withRenderingMode(.alwaysOriginal)
        
    
        setuplabels(lbl: addRoomlbl, text: "+ Add Room", textcolor: .WhiteColor, font: .InterBold(size: 16), align: .center)
        addRoomBtnView.backgroundColor = HexColor("#0095DA")
        ...
        room1ChildageView1.addCornerRadiusWithShadow(color: .clear, borderColor: .BorderColor, cornerRadius: 3)
        childage2View.isHidden = true
        room1ChildageView2.backgroundColor = .WhiteColor
        room1ChildageView2.addCornerRadiusWithShadow(color: .clear, borderColor: .BorderColor, cornerRadius: 3)
        
        setuplabels(lbl: room1Child1Titlelbl, text: "Child 1", textcolor: .ApplabelColor, font: .InterRegular(size: 14), align: .center)
        setuplabels(lbl: room1Child2Titlelbl, text: "Child 2", textcolor: .ApplabelColor, font: .InterRegular(size: 14), align: .center)
        setuplabels(lbl: room1childagevalue1lbl, text: "0", textcolor: .ApplabelColor, font: .InterRegular(size: 14), align: .center)
        setuplabels(lbl: room1childagevalue2lbl, text: "0", textcolor: .ApplabelColor, font: .InterRegular(size: 14), align: .center)
        ...
        room2ChildageView1.addCornerRadiusWithShadow(color: .clear, borderColor: .BorderColor, cornerRadius: 3)
        r2childage2View.isHidden = true
        room2ChildageView2.backgroundColor = .WhiteColor
        room2ChildageView2.addCornerRadiusWithShadow(color: .clear, borderColor: .BorderColor, cornerRadius: 3)
        
        setuplabels(lbl: room2Child1Titlelbl, text: "Child 1", textcolor: .ApplabelColor, font: .InterRegular(size: 14), align: .center)
        setuplabels(lbl: room2Child2Titlelbl, text: "Child 2", textcolor: .ApplabelColor, font: .InterRegular(size: 14), align: .center)
        setuplabels(lbl: room2childagevalue1lbl, text: "0", textcolor: .ApplabelColor, font: .InterRegular(size: 14), align: .center)
        setuplabels(lbl: room2childagevalue2lbl, text: "0", textcolor: .ApplabelColor, font: .InterRegular(size: 14), align: .center)
        ...
        room3ChildageView1.addCornerRadiusWithShadow(color: .clear, borderColor: .BorderColor, cornerRadius: 3)
        r3childage2View.isHidden = true
        room3ChildageView2.backgroundColor = .WhiteColor
        room3ChildageView2.addCornerRadiusWithShadow(color: .clear, borderColor: .BorderColor, cornerRadius: 3)
        
        setuplabels(lbl: room3Child1Titlelbl, text: "Child 1", textcolor: .ApplabelColor, font: .InterRegular(size: 14), align: .center)
        setuplabels(lbl: room3Child2Titlelbl, text: "Child 2", textcolor: .ApplabelColor, font: .InterRegular(size: 14), align: .center)
        setuplabels(lbl: room3childagevalue1lbl, text: "0", textcolor: .ApplabelColor, font: .InterRegular(size: 14), align: .center)
        setuplabels(lbl: room3childagevalue2lbl, text: "0", textcolor: .ApplabelColor, font: .InterRegular(size: 14), align: .center)
        ...
        room4ChildageView1.addCornerRadiusWithShadow(color: .clear, borderColor: .BorderColor, cornerRadius: 3)
        r4childage2View.isHidden = true
        room4ChildageView2.backgroundColor = .WhiteColor
        room4ChildageView2.addCornerRadiusWithShadow(color: .clear, borderColor: .BorderColor, cornerRadius: 3)
        
        setuplabels(lbl: room4Child1Titlelbl, text: "Child 1", textcolor: .ApplabelColor, font: .InterRegular(size: 14), align: .center)
        setuplabels(lbl: room4Child2Titlelbl, text: "Child 2", textcolor: .ApplabelColor, font: .InterRegular(size: 14), align: .center)
        setuplabels(lbl: room4childagevalue1lbl, text: "0", textcolor: .ApplabelColor, font: .InterRegular(size: 14), align: .center)
        setuplabels(lbl: room4childagevalue2lbl, text: "0", textcolor: .ApplabelColor, font: .InterRegular(size: 14), align: .center)
    ...
    func setupUI1() {
        ...
        setuplabels(lbl: titlelbl1, text: "Room 1", textcolor: .ApplabelColor, font: .InterRegular(size: 16), align: .left)
        setuplabels(lbl: adultslbl1, text: "Adults", textcolor: .ApplabelColor, font: .InterRegular(size: 18), align: .left)
        setuplabels(lbl: adultsSubtitlelbl1, text: "From 12 years old", textcolor: .SubTitleColor, font: .InterRegular(size: 14), align: .left)
        setuplabels(lbl: adultsCountlbl1, text: "2", textcolor: HexColor("#27272A"), font: .InterRegular(size: 18), align: .center)
        aIncrementBtn1.setTitle("", for: .normal)
        aDecrementBtn1.setTitle("", for: .normal)
        
        setuplabels(lbl: childrenlbl1, text: "Children", textcolor: .ApplabelColor, font: .InterRegular(size: 18), align: .left)
        setuplabels(lbl: childrenSubtitlelbl1, text: "From 2-11 years", textcolor: .SubTitleColor, font: .InterRegular(size: 14), align: .left)
        setuplabels(lbl: childrenCountlbl1, text: "0", textcolor: .ApplabelColor, font: .InterRegular(size: 18), align: .center)
    ...
    func setupUI2() {
        ...
        setuplabels(lbl: titlelbl2, text: "Room 2", textcolor: .ApplabelColor, font: .InterRegular(size: 16), align: .left)
        setuplabels(lbl: adultslbl2, text: "Adults", textcolor: .ApplabelColor, font: .InterRegular(size: 18), align: .left)
        setuplabels(lbl: adultsSubtitlelbl2, text: "+12 yrs", textcolor: .SubTitleColor, font: .InterRegular(size: 14), align: .left)
        setuplabels(lbl: adultsCountlbl2, text: "1", textcolor: HexColor("#27272A"), font: .InterRegular(size: 18), align: .center)
        aIncrementBtn1.setTitle("", for: .normal)
        aDecrementBtn1.setTitle("", for: .normal)
        
        setuplabels(lbl: childrenlbl2, text: "Children", textcolor: .ApplabelColor, font: .InterRegular(size: 18), align: .left)
        setuplabels(lbl: childrenSubtitlelbl2, text: "+2-12 yrs", textcolor: .SubTitleColor, font: .InterRegular(size: 14), align: .left)
        setuplabels(lbl: childrenCountlbl2, text: "0", textcolor: .ApplabelColor, font: .InterRegular(size: 18), align: .center)
        cIncrementBtn1.setTitle("", for: .normal)
        cDecrementBtn1.setTitle("", for: .normal)
    ...
    func setupUI3() {
        ...
        setuplabels(lbl: titlelbl3, text: "Room 3", textcolor: .ApplabelColor, font: .InterRegular(size: 16), align: .left)
        setuplabels(lbl: adultslbl3, text: "Adults", textcolor: .ApplabelColor, font: .InterRegular(size: 18), align: .left)
        setuplabels(lbl: adultsSubtitlelbl3, text: "+12 yrs", textcolor: .SubTitleColor, font: .InterRegular(size: 14), align: .left)
        setuplabels(lbl: adultsCountlbl3, text: "1", textcolor: HexColor("#27272A"), font: .InterRegular(size: 18), align: .center)
        aIncrementBtn1.setTitle("", for: .normal)
        aDecrementBtn1.setTitle("", for: .normal)
        
        setuplabels(lbl: childrenlbl3, text: "Children", textcolor: .ApplabelColor, font: .InterRegular(size: 18), align: .left)
        setuplabels(lbl: childrenSubtitlelbl3, text: "+2-12 yrs", textcolor: .SubTitleColor, font: .InterRegular(size: 14), align: .left)
        setuplabels(lbl: childrenCountlbl3, text: "0", textcolor: .ApplabelColor, font: .InterRegular(size: 18), align: .center)
        cIncrementBtn1.setTitle("", for: .normal)
        cDecrementBtn1.setTitle("", for: .normal)
    ...
    func setupUI4() {
        ...
        setuplabels(lbl: titlelbl4, text: "Room 4", textcolor: .ApplabelColor, font: .InterRegular(size: 16), align: .left)
        setuplabels(lbl: adultslbl4, text: "Adults", textcolor: .ApplabelColor, font: .InterRegular(size: 18), align: .left)
        setuplabels(lbl: adultsSubtitlelbl4, text: "+12 yrs", textcolor: .SubTitleColor, font: .InterRegular(size: 14), align: .left)
        setuplabels(lbl: adultsCountlbl4, text: "1", textcolor: HexColor("#27272A"), font: .InterRegular(size: 18), align: .center)
        aIncrementBtn1.setTitle("", for: .normal)
        aDecrementBtn1.setTitle("", for: .normal)
        
        setuplabels(lbl: childrenlbl4, text: "Children", textcolor: .ApplabelColor, font: .InterRegular(size: 18), align: .left)
        setuplabels(lbl: childrenSubtitlelbl4, text: "+2-12 yrs", textcolor: .SubTitleColor, font: .InterRegular(size: 14), align: .left)
        setuplabels(lbl: childrenCountlbl4, text: "0", textcolor: .ApplabelColor, font: .InterRegular(size: 18), align: .center)
        cIncrementBtn1.setTitle("", for: .normal)
        cDecrementBtn1.setTitle("", for: .normal)
    ...
    @objc func childrenIncrementButtonAction(_ sender:UIButton){
        ...
        if childCount == 0 {
            decrimentImage.image = UIImage(named: "sub")
        } else {
            decrimentImage.image = UIImage(named: "sub")
        }
    ...
    @objc func childrenIncrementButtonAction2(_ sender:UIButton){
        ...
        if childCount2 == 0 {
            decrimentImage2.image = UIImage(named: "sub")
        } else {
            decrimentImage2.image = UIImage(named: "sub")
        }
    ...
    @objc func childrenIncrementButtonAction3(_ sender:UIButton){
        delegate?.childrenIncrementButtonAction3(cell: self)
         ...
         if childCount3 == 0 {
             decrimentImage3.image = UIImage(named: "sub")
         } else {
             decrimentImage3.image = UIImage(named: "sub")
         }
    ...
    @objc func childrenIncrementButtonAction4(_ sender:UIButton){
        ...
        if childCount4 == 0 {
            decrimentImage4.image = UIImage(named: "sub")
        } else {
            decrimentImage4.image = UIImage(named: "sub")
        }
    }
