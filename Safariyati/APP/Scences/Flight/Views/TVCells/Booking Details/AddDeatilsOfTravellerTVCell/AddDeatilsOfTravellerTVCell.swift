...
class AddDeatilsOfTravellerTVCell: TableViewCell, CountryListVMDelegate {
...
//        setupView(v: flyerPgmBtnView)
    ...
    func setupTitleDropDown() {
        ...
        titledropDown.selectionAction = { [weak self] (index: Int, item: String) in
            ...
            self?.titleView.layer.borderColor = UIColor.BorderColor.cgColor
...
//    }
    ...
    func setupIssuingCountryDropDown() {
        ...
        dropDown1.selectionAction = { [weak self] (index: Int, item: String) in
            ...
            self?.issuecountryView.layer.borderColor = UIColor.BorderColor.cgColor
    ...
    @objc func donedatePicker(){
        ...
        if dobTF.isFirstResponder {
            ...
            self.dobView.layer.borderColor = UIColor.BorderColor.cgColor
            ...
            self.passportexpireView.layer.borderColor = UIColor.BorderColor.cgColor
            ...
            if let passportExpireDate = formatter.date(from: (passportExpireDateTF.text ?? "")) {
                ...
                if let threeMonthsLater = calendar.date(byAdding: .month, value: 3, to: currentDate) {
                    ...
                    if passportExpireDate == Date()  {
                        ...
                        passportexpireView.layer.borderColor = UIColor.BorderColor.cgColor
    ...
    @objc func editingTextField1(textField: UITextField) {
        ...
        if let text = textField.text, !text.isEmpty {
            ...
            switch textField {
            case fnameTF:
                fnameView.layer.borderColor = UIColor.BorderColor.cgColor
                travelerArray[indexposition].firstName = text
                break
                
            case lnameTF:
                lnameView.layer.borderColor = UIColor.BorderColor.cgColor
                travelerArray[indexposition].lastName = text
                break
                
                
            case passportnoTF:
                passportnoView.layer.borderColor = UIColor.BorderColor.cgColor
...
extension AddDeatilsOfTravellerTVCell {
    ...
    func setAttributedText(str1:String,str2:String)  {
        ...
        let atter2 = [NSAttributedString.Key.foregroundColor:UIColor.Buttoncolor,NSAttributedString.Key.font:UIFont.InterRegular(size: 10)] as [NSAttributedString.Key : Any]
