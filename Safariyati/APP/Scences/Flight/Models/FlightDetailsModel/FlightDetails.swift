...
struct FlightDetails : Codable {
	...
	let fdclass : FlightClass?
	let flight_number : String?
	let marketing_flight_number : String?
	let no_of_stops : Int?
	...
	enum CodingKeys: String, CodingKey {
		...
		case marketing_flight_number = "marketing_flight_number"
	...
	init(from decoder: Decoder) throws {
		...
		fdclass = try values.decodeIfPresent(FlightClass.self, forKey: .fdclass)
		flight_number = try values.decodeIfPresent(String.self, forKey: .flight_number)
		marketing_flight_number = try values.decodeIfPresent(String.self, forKey: .marketing_flight_number)
